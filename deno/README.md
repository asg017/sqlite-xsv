...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sqlite-xsv@0.2.1-alpha.10/mod.ts)
...
import * as sqlite_xsv from "https://deno.land/x/sqlite_xsv@v0.2.1-alpha.10/mod.ts";
